...
class Testshe_zhi:
    ...
    def test_case_0(self, api_client):
        ...
        """
        # 调用API方法
        if hasattr(api_client, 'post_get_co2_standard_value28088'):
            response = getattr(api_client, 'post_get_co2_standard_value28088')()
            assert response is not None, "响应为空"
        else:
            pytest.skip(f"方法 post_get_co2_standard_value28088 不存在")
