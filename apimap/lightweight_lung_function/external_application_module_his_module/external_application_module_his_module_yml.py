...
class ExternalApplicationModuleHisModuleAPI(BaseAPI):
    """外部申请模块 - his模块 接口"""
    ...
    def post_set_his_server_setting28300(self, param=""):
        """
        保存his设置
        请求方法: POST
    ...
    def post_out_apply_sheet_select28309(self, param=""):
        """
        检查单申请 - 选择检查单
        请求方法: POST
    ...
    def get_get_log_list28304(self, param=""):
        """
        获取请求日志
        请求方法: GET
    ...
    def post_out_apply_patient_select28308(self, param=""):
        """
        患者申请 - 选择患者
        请求方法: POST
    ...
    def get_get_his_server_setting28299(self, param=""):
        """
        获取his设置
        请求方法: GET
    ...
    def get_refresh_config28302(self, param=""):
        """
        刷新配置
        请求方法: GET
    ...
    def post_get_agent_apply_patient_page28305(self, param=""):
        """
        获取患者申请列表
        请求方法: POST
    ...
    def post_get_agent_apply_sheet_list_page28306(self, param=""):
        """
        获取申请检查单列表
        请求方法: POST
    ...
    def post_get_agent_apply_sheet_page28307(self, param=""):
        """
        获取申请检查单列表
        请求方法: POST
    ...
    def get_test_server28301(self, param=""):
        """
        测试服务
        请求方法: GET
    ...
    def get_get_config28303(self, param=""):
        """
        获取配置1
        请求方法: GET
